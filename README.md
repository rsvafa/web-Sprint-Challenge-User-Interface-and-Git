...
Semantic HTML helps give context to the coding that you are inputing.
2. Name two big differences between ```display: block;``` and ```display: inline;```.
Display block allows width and height. Inline does not respect top and bottom margin and paddings.
3. What are the 4 areas of the box model?
Padding, margin, border, content
4. While using flexbox, what axis does the following property work on: ```align-items: center```?
Aligns on the X-axis
5. Explain why git is valuable to a team of developers.
Git allows others to see what you have done with code and also to go back to older code
